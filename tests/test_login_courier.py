...
class TestLoginCourier:
    ...
    def test_empty_password_login(self):
        ...
        logged_in_courier_request.json()['message'] = message

        assert logged_in_courier_request.status_code == 400 and logged_in_courier_request.json()['message'] == message
    ...
    def test_wrong_password_login(self):
        ...
        assert logged_in_courier_request.status_code == 404 and logged_in_courier_request.json()['message'] == message
    ...
    def test_not_existed_courier_login(self, default_login_courier):
        ...
        message = "Учетная запись не найдена"
        not_existed_courier.json()['message'] = message

        assert not_existed_courier.status_code == 404 and not_existed_courier.json()['message'] == message
